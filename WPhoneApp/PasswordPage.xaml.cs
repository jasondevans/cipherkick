    ...
    public sealed partial class PasswordPage : Page
    {
        ...
        private async void passwordBox_KeyDown(object sender, KeyRoutedEventArgs e)
        {
            if (e.Key == VirtualKey.Enter)
            {
                ...
                sharedState.password = passwordBox.Password;
                bool passwordVerified = await sharedState.verifyPassword();
                if (passwordVerified)
                {
                    sharedState.loadDataAsync();
                    this.Frame.Navigate(typeof(ListPage));
                }
                else
                {
                    sharedState.displayMessage = "Password incorrect.";
